...
namespace TE_DFA.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        private readonly Dotnet_CoreContext _context;

        public EmployeesController(ILogger<EmployeesController> logger, IToastNotification toastNotification,Dotnet_CoreContext context)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Create([Bind("Eid,Ename,Eage,Edes")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Eid,Ename,Eage,Edes")] Employee employee)
        {
            if (id != employee.Eid)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Dotnet_CoreContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
